...
// Phone image paths - update these when uploading actual images
const PHONE_LEFT_IMAGE = '/mobile/phone-left.png';
const PHONE_RIGHT_IMAGE = '/mobile/phone-right.png';
  ...
  return (
    <section className="section-padding">
      ...
      >
        ...
        {/* Right Content - Dual Phone Images */}
